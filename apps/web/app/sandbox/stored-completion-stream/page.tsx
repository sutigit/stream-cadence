...
export default function Home() {
    ...
    return (
        <main className="container mx-auto h-screen max-h-screen min-h-screen flex flex-col">
            <h1 className="px-20 pt-5 text-xl text-red-300 text-center w-full">stored-completion-stream</h1>
            <section className="px-20 flex-2 h-full flex flex-col justify-center items-center">
                <div
                    className="bg-indigo-300/3 p-10 rounded-2xl w-full flex mb-20 overflow-y-scroll h-[9rem] whitespace-pre-wrap pr-8 scroll-bar"
                    ref={scrollRef}
                >
